...
class _PostIdeaScreenState extends State<PostIdeaScreen> {
  ...
  final TextEditingController _solutionRemarkController = TextEditingController();
  @override
      ...
      body: Container(
        ...
        child:Column(
          ...
          children: [
            ...
            Text('Problem: ${widget.problem['title']}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
            addVerticalSpace(),
            Text('Solution Remark', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
            addVerticalSpace(),
            Text('Write your solution here', style: TextStyle(fontSize: 16),),
            ...
            Row(
              ...
              children: [
                ColoredButton(
                  ...
                  child: Text('Post', style: TextStyle(color: COLOR_BASE, fontSize: 20, fontWeight: FontWeight.bold),),
                ),
              ],
            )
          ],
