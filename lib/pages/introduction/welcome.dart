import 'package:election/pages/card_list.dart';
    ...
    return IntroductionScreen(
      pages: [
        PageViewModel(
          ...
          image: Center(child: Icon(Icons.flutter_dash, size: 100, color: Colors.blue)),
        ...
        PageViewModel(
          ...
          image: const Center(child: Icon(Icons.rocket_launch, size: 100, color: Colors.purple)),
        ),
      ],
